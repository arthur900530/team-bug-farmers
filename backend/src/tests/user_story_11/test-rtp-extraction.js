...
const SignalingServer_1 = require("../SignalingServer");
const MeetingRegistry_1 = require("../MeetingRegistry");
...
async function testRtpExtraction() {
    ...
    try {
        ...
        const meetingRegistry = new MeetingRegistry_1.MeetingRegistry();
        ...
        const signalingServer = new SignalingServer_1.SignalingServer(8081, meetingRegistry, mediasoupManager);
...
`;
        ...
        const opusCodec = rtpParams.codecs.find((c) => c.mimeType === 'audio/opus');
        if (!opusCodec) {
